pcc : Queue.o Stack.o HashTable.o LexicalAnalyzer.o CodeGenerator.o Parser.o VirtualMachine.o CompilerDriver.o
	cc -o pcc Queue.o Stack.o HashTable.o LexicalAnalyzer.o CodeGenerator.o Parser.o VirtualMachine.o CompilerDriver.o
...
Parser.o : ./Parser/Parser.c ./Parser/Parser.h ./Auxiliar\ Structures/Queue.h ./Auxiliar\ Structures/HashTable.h ./Code\ Generator/CodeGenerator.h
...
clean :
	rm pcc Queue.o Stack.o HashTable.o LexicalAnalyzer.o CodeGenerator.o Parser.o VirtualMachine.o CompilerDriver.o